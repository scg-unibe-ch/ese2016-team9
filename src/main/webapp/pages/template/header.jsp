...
<meta name="google-signin-client_id"
	content="601046239237-r1etvc978bl3evkdlp9k4blmtpp210i0.apps.googleusercontent.com">
...
<script>
	...
	$(document).ready(function() {
		...
		$(".negative-message").on("click", function() {
			$(".negative-message").hide()
		});
        $(".auctionTimerDisplay").each(function(index) {
            auctionTimer(this, this.textContent);
    ...
    function auctionTimer(object, endtime) {
        var timeinterval = setInterval(function(){
            var t = getTimeRemaining(endtime);
            object.innerHTML = t.days + ' Days, ' + t.hours + ':' + ('0' + t.minutes).slice(-2) + ':' + ('0' + t.seconds).slice(-2);
            if(t.total<=0) {
...
<header>
 ...
 %> <span class="caret"></span>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="/user?id=<%out.print(realUser.getId());%>">Public
										Profile</a></li>
								<%
									if (!realUser.isPremium()) {
								%>
								...
								%>
								<li role="presentation"><a href="/logout"
