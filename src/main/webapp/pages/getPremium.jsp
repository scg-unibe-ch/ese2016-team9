...
<pre>Get Premium</pre>
    ...
    <p align="center">
        Welcome to a-Bec, the best site to get to a new flat or house. To get an premium account, you have to provide <b>30.00.-</b>. Please submit your credit card credentials.
    </p>
    ...
    <form class="form-horizontal" method="post">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <button type="submit" class="btn btn-default">Get premium</button>
            </div>
        </div>
    </form>
